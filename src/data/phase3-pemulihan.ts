...
export const PHASE3_SPOTS: readonly MapSpot[] = [
    ...
    "options": [
      {
        ...
        "prepPoints": 12,
        "safetyDelta": 8,
        "feedback": "Lumpur banjir membawa kuman leptospirosis dan tetanus. Alat pelindung diri itu wajib.",
        "award": {
          "logistik": 8,
          "rentan": 6
        }
    ...
    "options": [
      {
        ...
        "prepPoints": 8,
        "safetyDelta": 12,
        "feedback": "Sumur yang terendam tercemar. Diare adalah penyakit paling umum pasca banjir — air matang menyelamatkan.",
        "award": {
          "logistik": 10,
          "rentan": 4
        }
    ...
    "options": [
      {
        ...
        "prepPoints": 6,
        "safetyDelta": 12,
        "feedback": "Pemeriksaan dini mencegah penyakit pasca banjir menjadi berat. Nenek mendapat obat rutinnya lagi.",
        "award": {
          "rentan": 12
        }
      },
  ...
  },
  {
    ...
    "prompt": "Malam harinya keluarga berkumpul dengan lilin. Ibu mengusulkan membicarakan apa yang bisa diperbaiki.",
    "options": [
      {
        "text": "Buat rencana keluarga: titik kumpul, nomor darurat (112, BPBD), tugas tiap orang, isi ulang tas siaga.",
        "hourCost": 1,
        "prepPoints": 18,
        "feedback": "Rencana keluarga tertulis membuat semua orang tahu tugasnya. Bencana berikutnya, kalian lebih siap.",
        "award": {
          "mitigasi": 12,
          "informasi": 6
        }
  ...
  },
  {
    ...
    "prompt": "Pak RT mengajak kerja bakti: sungai penuh sampah dan lereng bukit gundul setelah longsor.",
    "options": [
      {
        "text": "Ikut kerja bakti: bersihkan sungai, tanam vetiver dan pohon di lereng, pasang papan tanda rawan longsor.",
        "hourCost": 3,
        "prepPoints": 18,
        "feedback": "Akar tanaman mengikat tanah dan sungai bersih mengurangi luapan. Ini mitigasi jangka panjang yang nyata.",
        "award": {
          "mitigasi": 18
        }
      },
    ...
    "options": [
      {
        ...
        "feedback": "Gotong royong mempercepat pemulihan dan mengubah sikap Pak Darto tentang peringatan dini.",
        "award": {
          "rentan": 8,
          "mitigasi": 4
        }
      ...
      },
      {
        ...
        "hourCost": 0,
        "prepPoints": 0,
        "feedback": "Komunitas yang saling bantu pulih lebih cepat daripada yang bergerak sendiri-sendiri."
      }
    ]
  }
]

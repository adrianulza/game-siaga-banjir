...
export const PHASE1_SPOTS: readonly MapSpot[] = [
  {
    ...
    "prompt": "Ponsel bergetar: ada notifikasi peringatan dini cuaca. Ibu bertanya, “Itu dari mana, Nak?”",
    "options": [
      {
        "text": "Buka aplikasi/website BMKG, catat status peringatan dan perkiraan hujan lebat 3 hari ke depan.",
        "hourCost": 1,
        "prepPoints": 15,
        "feedback": "Tepat! Peringatan dini resmi datang dari BMKG untuk cuaca dan BNPB/BPBD untuk bencana. Info dari sumber resmi mencegah panik karena hoaks.",
        "award": {
          "informasi": 16
        },
        "grantsTags": [
      ...
      },
      {
        ...
        "hourCost": 1,
        "prepPoints": 3,
        "feedback": "Pesan berantai sering tidak benar. Selalu cek ulang ke sumber resmi sebelum percaya, apalagi menyebarkan.",
        "award": {
          "informasi": 4
        }
      },
      {
        ...
        "hourCost": 0,
        "prepPoints": 0,
        "feedback": "Peringatan dini itu waktu berharga. Mengabaikannya berarti kehilangan kesempatan bersiap."
      }
    ]
  },
  {
    ...
    "prompt": "Ibu mengeluarkan ransel kosong. “Kalau kita harus mengungsi malam ini, apa yang perlu dibawa?”",
    "options": [
      {
        ...
        "hourCost": 2,
        "prepPoints": 20,
        "feedback": "Itulah isi Tas Siaga Bencana yang ideal — cukup untuk 3 hari dan diletakkan di tempat yang mudah dijangkau.",
        "award": {
          "logistik": 20
        },
        "grantsTags": [
      ...
      },
      {
        ...
        "hourCost": 1,
        "prepPoints": 6,
        "feedback": "Camilan boleh, tapi air minum, obat, senter, dan dokumen jauh lebih penting saat mengungsi.",
        "award": {
          "logistik": 6
        }
      },
      {
        ...
        "hourCost": 0,
        "prepPoints": 0,
        "feedback": "Saat air naik, tidak ada waktu berkemas. Tas siaga harus siap sebelum bencana datang."
      }
    ]
  },
  {
    ...
    "prompt": "Ayah memanggil dari halaman. Talang penuh daun dan selokan depan rumah tersumbat sampah.",
    "options": [
      {
        "text": "Bantu Ayah membersihkan talang dan selokan, lalu angkat barang elektronik ke tempat tinggi.",
        "hourCost": 2,
        "prepPoints": 15,
        "feedback": "Selokan yang lancar mengurangi genangan, dan barang di tempat tinggi aman dari air. Kerja tim!",
        "award": {
          "mitigasi": 12,
          "logistik": 6
        },
      ...
      },
      {
        ...
        "hourCost": 1,
        "prepPoints": 4,
        "feedback": "Melihat saja tidak mengubah apa pun. Selokan tersumbat memperparah banjir di depan rumah.",
        "award": {
          "mitigasi": 3
        }
      },
  ...
  },
  {
    ...
    "prompt": "Warga berkumpul di tanggul. Papan ukur ketinggian air sudah menyentuh garis kuning: status Waspada.",
    "options": [
      {
        "text": "Bantu menyusun karung pasir dan catat ketinggian air tiap jam untuk dilaporkan ke Pak RT.",
        "hourCost": 3,
        "prepPoints": 18,
        "feedback": "Memantau ketinggian air dan memperkuat tanggul adalah langkah nyata mengurangi risiko banjir.",
        "award": {
          "mitigasi": 14,
          "informasi": 6
        },
      ...
      },
      {
        ...
        "prepPoints": 2,
        "safetyDelta": -5,
        "feedback": "Tepi sungai saat air naik itu berbahaya — arus bisa tiba-tiba deras. Jaga jarak dari bibir sungai!"
      },
      {
    ...
    "options": [
      {
        ...
        "hourCost": 2,
        "prepPoints": 18,
        "feedback": "Mengetahui jalur dan titik kumpul menghemat waktu berharga saat evakuasi. Kentongan bertalu-talu artinya bahaya!",
        "award": {
          "informasi": 12,
          "rentan": 6
        },
      ...
      },
      {
        ...
        "hourCost": 1,
        "prepPoints": 8,
        "feedback": "Lumayan, tapi detail penting seperti tanda bahaya dan titik kumpul bisa terlewat.",
        "award": {
          "informasi": 5
        }
      },
  ...
  },
  {
    ...
    "prompt": "Nenek tinggal di rumah kecil dekat lereng bukit. Kucing Oyen tidur di kandang bambu di terasnya.",
    "options": [
      {
        "text": "Siapkan obat rutin Nenek, pindahkan barang berharga ke rak atas, siapkan kandang angkut dan makanan Oyen.",
        "hourCost": 2,
        "prepPoints": 16,
        "feedback": "Lansia, anak kecil, dan hewan peliharaan butuh persiapan khusus — kamu sudah memikirkannya!",
        "award": {
          "rentan": 20
        },
        "grantsTags": [
